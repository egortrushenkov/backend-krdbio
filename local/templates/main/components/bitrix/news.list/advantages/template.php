...
<section class="container">
    <?php \lib\KitTPL::subtitle("{text:'".$arResult['NAME']."', className: 'sm:text-center mb-8 sm:mb-11 lg:mb-14 clip-path clip-path-up ease-linear duration-1000', data: 'data-anim'}"); ?>
