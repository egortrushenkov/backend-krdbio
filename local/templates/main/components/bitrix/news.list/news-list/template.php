...
<section class="container">
    <?php \lib\KitTPL::title("{text: 'НОВОСТИ', className: 'mb-8 sm:mb-11 lg:mb-14 clip-path clip-path-up ease-linear duration-1000', data: 'data-anim'}");?>
    <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div class="anim anim-up ease-in-out duration-700" data-anim id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
            <div class="card border border-solid border-gray">
                <a class="pack pack-[65] bg-gray rounded-t-inherit" data-waved="light" draggable="false" href="<?= $arItem['DETAIL_PAGE_URL'] ?>">
                ...
                <div class="card-content p-4 sm:p-6">
                    ...
                    <div class="flex flex-col gap-4 sm:gap-6 mt-auto">
                        <a class="btn btn-primary btn-fill btn-light btn-lg swiper-no-swiping" data-waved="light" draggable="false" href="<?= $arItem['DETAIL_PAGE_URL'] ?>">Подробнее</a>
                    </div>
                </div>
            </div>
        </div>
