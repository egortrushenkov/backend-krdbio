	...
	<body>
        <main>
            ...
            <header class="container hidden lg:flex items-center justify-between gap-10 sticky top-0 z-30 bg-beige py-4">
                ...
                <a class="btn btn-primary btn-fill btn-light btn-md shrink-0" data-fancybox-form data-waved="light" draggable="false" href="/dialogs/dialog-feedback.html">Связаться с нами</a>
            </header>
